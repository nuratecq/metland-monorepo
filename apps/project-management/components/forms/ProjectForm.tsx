...
export function ProjectForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3 bg-white border rounded-lg p-4">
      ...
      <div><label className="text-xs font-semibold tracking-widest uppercase">Project Name *</label><input name="name" required className="w-full border rounded px-3 py-2 text-sm" placeholder="Metland Menteng" /></div>
