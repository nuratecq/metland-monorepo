...
/** Search powerful tanpa AI — filter Category/Spec/Location/Price/Availability */
export async function GET(req: NextRequest) {
  ...
  // extended filters — Price/Availability/Brand (contractor price via portfolio future, here stub)
